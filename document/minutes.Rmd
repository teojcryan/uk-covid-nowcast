...
-   Plotted cases over time by reporting delay
    ...
    -   Would be interesting to see if the distribution of delays changed over time maybe due to testing advice ![](../output/cases-delay.png)

## Theory
The nowcasting problem is described as follows [@höhle2014].
