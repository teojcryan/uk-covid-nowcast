...
filenames <- list.files(path = here("data", "cases", "region_age"), 
...
setcolorder(dt, c("specimen_date", "areaName", "age_gp", "cases", "report_date"))      # reorder columns of data table
...
saveRDS(dt, file = here::here("data","cases","region_age","merged.rds"))
